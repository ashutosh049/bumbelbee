...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="resources/css/colorbox.min.css" />
							...
							<div class="col-xs-12">
								...
								<div>
									<ul class="ace-thumbnails clearfix">
										<li>
											<a href="resources/images/gallery/image-1.jpg" title="Photo Title" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="resources/images/gallery/thumb-1.jpg" />
											</a>
										...
										<li>
											<a href="resources/images/gallery/image-2.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="resources/images/gallery/thumb-2.jpg" />
												<div class="text">
										...
										<li>
											<a href="resources/images/gallery/image-3.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="resources/images/gallery/thumb-3.jpg" />
												<div class="text">
													<div class="inner">Sample Caption on Hover</div>
												</div>
											</a>
										...
										<li>
											<a href="resources/images/gallery/image-4.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="resources/images/gallery/thumb-4.jpg" />
												<div class="tags">
													<span class="label-holder">
										...
										<li>
											<div>
												<img width="150" height="150" alt="150x150" src="resources/images/gallery/thumb-5.jpg" />
												<div class="text">
													<div class="inner">
														<span>Some Title!</span>

														<br />
														<a href="resources/images/gallery/image-5.jpg" data-rel="colorbox">
										...
										<li>
											<a href="resources/images/gallery/image-6.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="resources/images/gallery/thumb-6.jpg" />
											</a>
										...
										<li>
											<a href="resources/images/gallery/image-1.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="resources/images/gallery/thumb-1.jpg" />
											</a>
...
<![endif]-->
	...
	$("#cboxLoadingGraphic")("<i class='ace-icon fa fa-spinner orange fa-spin'></i>");//let's add a custom loading icon
