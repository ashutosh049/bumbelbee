...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Email Templates - BumbelBee</title>
								...
								<div class="row">
									<div class="col-xs-3">
										<a href="email-confirmation" class="thumbnail" target="_blank">
											<img class="img-responsive" src="resources/images/email/email1.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="email-navbar" class="thumbnail" target="_blank">
											<img class="img-responsive" src="resources/images/email/email2.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="email-newsletter" class="thumbnail" target="_blank">
											<img class="img-responsive" src="resources/images/email/email3.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="email-contrast" class="thumbnail" target="_blank">
											<img class="img-responsive" src="resources/images/email/email4.png" alt="Email Template" />
										</a>
									</div>
								</div>
