...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>jQuery UI - BumbelBee</title>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>
											Please see
											<a href="form-elements">form elements page</a>
			...
			*/
				...
				var spinner = $( "#spinner" ).spinner({
					create: function( event, ui ) {
						...
						$(this)
						.next().addClass('btn btn-success')('<i class="ace-icon fa fa-plus"></i>')
						.next().addClass('btn btn-danger')('<i class="ace-icon fa fa-minus"></i>')
