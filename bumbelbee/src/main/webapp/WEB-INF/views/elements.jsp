...
<meta charset="utf-8" />
<title>UI Elements - BumbelBee</title>
				...
				<ul class="nav ace-nav">
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#" class="clearfix"> <img
											src="resources/images/avatars/avatar.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="resources/images/avatars/avatar3.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="resources/images/avatars/avatar4.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="resources/images/avatars/avatar2.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="resources/images/avatars/avatar5.png" class="msg-photo"
					...
					<li class="light-blue dropdown-modal"><a
						data-toggle="dropdown" href="#" class="dropdown-toggle"> <img
							class="nav-user-photo" src="resources/images/avatars/user.jpg"
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							UI Elements <small> <i
								class="ace-icon fa fa-angle-double-right"></i> Common UI
								Features &amp; Elements
							</small>
						</h1>
					</div>
											...
											<div class="widget-main">
												<p class="muted">
													Tight pants next level keffiyeh <a title="Default tooltip"
														data-rel="tooltip" href="#">you probably</a> haven't heard
													of them. Farm-to-table seitan, mcsweeney's fixie
													sustainable quinoa 8-bit american apparel <a
														title="Another tooltip" data-rel="tooltip" href="#">have
														a</a> terry richardson vinyl chambray. A really ironic artisan
												...
												<p>
													...
													<span class="btn btn-warning btn-sm tooltip-warning"
														...
														title="Left Warning">Left</span> <span
														class="btn btn-success btn-sm tooltip-success"
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<h3 class="row header smaller lighter orange">
										...
										<span class="col-sm-4"> <label
											class="pull-right inline"> <small class="muted">Dark:</small>
									...
									<p>
										...
										<button class="btn btn-warning" id="gritter-max3">Max
											3</button>
							...
							<div class="row">
								<div class="col-sm-6">
									<div>
										...
										<p>
											<button class="btn" id="bootbox-regular">Regular
												Dialog</button>
										...
										<div class="col-xs-12">
											...
											<form class="form-horizontal" id="spinner-opts">
												...
												<label class="inline"> <small class="lighter">Length:</small>
													...
													<input class="hidden" type="text" name="length"
													data-min="0" data-max="30" value="7" />
												</label>
												...
												<label class="inline"> <small class="lighter">Radius:</small>
													...
													<input class="hidden" type="text" name="radius"
													data-min="0" data-max="40" value="10" />
												</label>
												...
												<label class="inline"> <small class="lighter">Corners:</small>
													...
													<input class="hidden" type="text" name="corners"
													data-min="0" data-max="1" data-step="0.1" value="1" />
												</label>
												...
												<label class="inline"> <small class="lighter">Rotate:</small>
													...
													<input class="hidden" type="text" name="rotate"
													data-min="0" data-max="90" value="0" />
												</label>
												...
												<label class="inline"> <small class="lighter">Trail:</small>
													...
													<input class="hidden" type="text" name="trail"
													data-min="10" data-max="100" value="60" />
												</label>
												...
												<label class="inline"> <small class="lighter">Speed:</small>
													...
													<input class="hidden" type="text" name="speed"
													data-min="0.5" data-max="2.2" data-step="0.1" value="1" />
												</label>
											</form>
										</div>
										<!-- /.row -->
								...
								<div class="col-sm-6">
									...
									<div class="dropup dropdown-preview">
										<ul class="dropdown-menu dropdown-light">
											...
											<li class="dropup dropdown-hover"><a href="#"
												tabindex="-1" class="clearfix"> <span class="pull-left">More
														options</span> <i class="ace-icon fa fa-caret-right pull-right"></i>
											</a>
									...
									<div class="dropup dropdown-preview">
										<ul class="dropdown-menu dropdown-purple">
											...
											<li class="dropdown-hover dropup"><a href="#"
												tabindex="-1" class="clearfix"> <span class="pull-left">More
														options</span> <i class="ace-icon fa fa-caret-left pull-right"></i>
											</a>

												<ul
													class="dropdown-menu dropdown-purple dropdown-menu-right">
													<li><a href="#" tabindex="-1">Second level link</a></li>
								...
								<div class="col-sm-6">
									<h3 class="row header smaller lighter blue">
										<span class="col-sm-7"> <i
											class="ace-icon fa fa-th-large"></i> Pills
										</span>
										<!-- /.col -->

										<span class="col-sm-5"> <label
											class="pull-right inline"> <small class="muted">Stacked:</small>
